        ...
        if savedsum + sum(throwndices) >= 30:       # om man når till 30 på detta kast
            ...
            if dicesnr == 3:                            # om slutspelet ska köras
                ...
                for i in range(len(throwndices)):           # kolla alla tärningar
                    if throwndices[i] == 6 or throwndices[i] == 5:  # kolla efter sexor och femmor
                        savedices.append(throwndices[i])    # lägg undan sexor och femmor

                if len(savedices) == 0:                 # om det inte finns några sexor eller femmor
...
results10000_10000luck = "Winrate: 61.19%, Lossrate: 38.81%"
"Winrate: 60.16%, Lossrate: 39.84%"
results100000_1000luck = "Winrate: 61.09%, Lossrate: 38.91%"
results1000000_100luck = "Winrate: 60.83%, Lossrate: 39.17%"